...
def compute_loss(output, pred_box, gt_box, gt_mask, num_boxes, num_classes, grid_size, image_size):
    ...
    # Compute losses for each bounding box
    # Compute losses
    # Compute losses for each component
    # Compute losses for each component
    # Loss for x-coordinate of bounding box center
    # Ensure pred_box and gt_box have consistent shapes for comparison
    # Extract bounding box attributes (x, y, w, h) from pred_box and gt_box
    # Extract confidence scores and class predictions
    
    #print("GT shape:", gt_box.shape)
    #print("Output shape:", output.shape)
    #print("box_mask shape:", box_mask.shape)
    #print("weight_coord shape:", weight_coord.shape)
